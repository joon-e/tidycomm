### Internal functions ###
# The following functions (rescale, rescale.numeric, rescale.NULL, etc.) were originally
# written by Hadley Wickham, Dana Seidel, and contributors under the MIT license.
# Source: https://rdrr.io/cran/scales/
# Package: scales
# Authors: Hadley Wickham [aut, cre], Dana Seidel [aut], RStudio [cph, fnd]
# Maintainer: Hadley Wickham <hadley@rstudio.com>
# License: MIT + file LICENSE
# These functions have been modified for internal use within this package.
# Changes made to the original code:
# - Export Tags: Removed `@export` tags to make functions internal.
# - Documentation: Added `@keywords internal` for appropriate categorization in package documentation.
