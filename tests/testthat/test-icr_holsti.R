...
test_that("Holsti computes correct result", {
  ...
  expect_equal(icr_holsti(m1n), 0.778, tolerance = .0005)
  expect_equal(icr_holsti(m1s), 0.778, tolerance = .0005)
  expect_equal(icr_holsti(m2n), 0.778, tolerance = .0005)
  expect_equal(icr_holsti(m2s), 0.778, tolerance = .0005)
})
